...
!function (a, b) {
    ...
    return e.init = function () {
        ...
        }, this), 300), this.set_dom_grid_width(), this.options.autogrow_cols && this.drag_api.set_limits(this.cols * this.min_widget_width), this.$widgets_to_move || (this.$widgets_to_move = []), this.$widgets_to_move.push(this.$resized_widget);
