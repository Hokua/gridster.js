/*! gridster.js - v0.5.6 - 2015-01-22 - * http://gridster.net/ - Copyright (c) 2015 ducksboard; Licensed MIT */
!function (a, b) {
    ...
    return e.init = function () {
        ...
        }).appendTo(this.$el), this.$resized_widget.addClass("resizing"), this.$widgets_to_move = [], this.options.resize.start && this.options.resize.start.call(this, b, c, this.$resized_widget), this.$el.trigger("gridster:resizestart")
    }, e.on_stop_resize = function (b, c) {
        if (this.$resized_widget.removeClass("resizing").css({width: "", height: ""}), delay(a.proxy(function () {
            ...
            }, this), 300), this.set_dom_grid_width(), this.options.autogrow_cols && this.drag_api.set_limits(this.cols * this.min_widget_width), this.$widgets_to_move) {
            for (var d = this.$widgets_to_move.length, e = 0; d > e; e++) {
                var f = this.$widgets_to_move[e];
        ...
        if (-1 === a.inArray(b, f)) {
            ...
            }, this)), h.row = i, this.update_widget_position(h, b), b.attr("data-row", h.row), this.$changed = this.$changed.add(b), f.push(b), this.is_clipped_vertically(h) && this.$widgets_to_move && -1 === a.inArray(b, this.$widgets_to_move) && this.$widgets_to_move.push(b)
        }
