/*! gridster.js - v0.5.6 - 2015-02-03 - * http://gridster.net/ - Copyright (c) 2015 Christopher Bruno; Licensed MIT */
!function (a, b) {
    ...
    }, e.arrange_widgets_no_vertical_clipping = function (a) {
        for (var b = a.length, c = 0; b > c; c++) {
            var d = a[c];
            this.is_clipped_vertically(d.coords().grid) && this.move_widget_to_closest_available_cell(d)
        }
